...
class ZedCamera(object):
    ...
    def __init__(self, camera_serial, lock):
        ...
        with open(self.pose_data_file, 'w') as f:
            f.write("timestamp,tx,ty,tz,ox,oy,oz,ow\n")  # CSV header
    ...
    def grab_frame(self, 
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            self.save_data(image_data, depth_data, pose_data, timestamp)
    ...
    def save_data(self, image_data, depth_data, pose_data, timestamp):
        ...
        with open(self.pose_data_file, "a") as f:
            f.write(f"{timestamp_ms},{tx},{ty},{tz},{ox},{oy},{oz},{ow}\n")
...
if __name__ == '__main__':
    try:
        ...
        for cam in cameras:
            ...
            thread = threading.Thread(target=camera_thread, args=(camera_serial, lock))
